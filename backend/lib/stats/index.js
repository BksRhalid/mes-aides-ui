...
var dirname = process.env.NODE_ENV === 'production' ? __dirname + '/../../../dist' : __dirname + '/../../../app';
var filename = dirname + '/documents/stats.json';
...
Promise.all([
    ...
    .then(function(data) { return fs.writeFileAsync(filename, JSON.stringify(data, null, 2), 'utf-8'); })
